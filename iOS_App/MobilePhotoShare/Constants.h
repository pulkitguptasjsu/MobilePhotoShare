...
#define BUCKET_NAME                     @"mobilephotoshare-photos3bucket-12vriueog6jys"
#define SERVER_ENDPOINT                 @"http://54.148.148.136"
 ...
 */
#define FB_ROLE_ARN @"arn:aws:iam::859651362189:role/MobilePhotoShare-FacebookWIFRole-QZE23V8K8ZFH"
