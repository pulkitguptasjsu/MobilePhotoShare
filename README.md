...
This is a sample iOS mobile application that demonstrates integration with AWS Tools and Services and Facebook for user identification and validation. The MobilePhotoShare App allows users to do the following:
   
   * Allow users to login using Facebook and google.
